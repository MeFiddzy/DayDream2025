...
public class MovementManager : MonoBehaviour
{
    ...
    public HashSet<KeyCode> useSwordKeys = new HashSet<KeyCode>{KeyCode.Z};
    ...
    private Transform m_followThis;
    ...
    public void Awake()
    {
        m_swordManager = GetComponent<SwordManager>();
        m_dashBGTransform = GameObject.Find("Dash Slider Background").GetComponent<Transform>();
        m_followThis = GameObject.Find("FollowPlayer").GetComponent<Transform>();
    ...
    public void Update()
    {
        m_swordManager.curDirection = m_lastDirection;
        ...
        // Dash slider follow
        m_followThis.position = transform.position;
    ...
    private void reloadConfig()
    {
        ...
        useSwordKeys = INIArrayToKeys(keystrokes.loadArray("use_sword"));
    }
}
